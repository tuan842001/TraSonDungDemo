              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div className="divmb3">
                    ...
                    <div class="mb-3">
                      <label label for="exampleDropdownFormPassword2" class="form-label">Email</label>
                      <input type="email" class="form-control" id="exampleDropdownFormPassword2" placeholder="Password" />
                    </div>
                  </div>
